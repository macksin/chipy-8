...
class CPU():
    ...
    def __init__(self, drawobj, screenobj, verbose):
        ...
        self.implemented = ['JUMP', 'LOAD', 'DRAW', 'LOAD I', 'LOGIC', 'ADD', 'SKNE', 'SKE']
    ...
    def jmp_to_nnn_plus_v0(self):
        ...
        self.pc = (jumpto + self.registers[0]) - 2
    ...
    def draw_spr(self):
        ...
        for b in range(length):
            ...
            for bit in [int(i) for i in list(bin(_byte))[2:]]:
                if bit == 1:
                ...
                x_location += 1
            x_location = self.opcode >> 5 & 0x000f
            y_location += 1
